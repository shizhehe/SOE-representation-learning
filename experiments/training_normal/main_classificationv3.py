...
if VNN:
    ckpt_path = os.path.join(ckpt_folder, dataset_name, model_name, time_label + "_VNN" + "_v3")
else:
    ckpt_path = os.path.join(ckpt_folder, dataset_name, model_name, time_label + "_v3")
