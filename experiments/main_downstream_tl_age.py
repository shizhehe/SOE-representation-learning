...
#model_ckpt = f'VN_Net_fold_{fold}_fixed_huge_normalized'
#model_ckpt_pretext = f'VN_Net_fold_{pretext_fold}_fixed_huge_normalized'
...
ckpt_path = os.path.join(ckpt_folder, dataset_name, model_name, f"week{week}", "age", f"{model_ckpt}{'_frozen' if froze_encoder else ''}")
